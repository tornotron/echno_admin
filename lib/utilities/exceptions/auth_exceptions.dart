...
///
/// This class represents exceptions that may occur during Firebase authentication processes,
/// providing specific error messages corresponding to different error codes.
///
/// Instances of this class encapsulate an error code, and through its getter [message],
/// retrieve the corresponding error message based on the error code.
class EchnoFirebaseAuthException implements Exception {
  /// The error code associated with the exception.
  final String code;

  /// Constructor that takes an [error code].
  ///
  /// The [code] parameter represents the error code associated with the exception.
  EchnoFirebaseAuthException(this.code);

  /// Retrieves the corresponding error message based on the error [code].
  ///
  /// This getter translates the error code into a meaningful error message
  /// for better understanding and user feedback.
  String get message {
    switch (code) {
